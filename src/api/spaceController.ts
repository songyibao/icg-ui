...
/** getSpaceVOByLoginUser GET /api/space/get/vo/unique */
export async function getSpaceVoByLoginUserUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponseSpaceVO_>('/api/space/get/vo/unique', {
    method: 'GET',
    ...(options || {}),
  })
}
